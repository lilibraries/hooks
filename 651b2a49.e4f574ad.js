...
// CONCATENATED MODULE: ./examples/UseToggleExample.tsx




function Example() {
  var _useToggle = Object(src["q" /* useToggle */])(true),
      _useToggle2 = slicedToArray_default()(_useToggle, 2),
      visible = _useToggle2[0],
      _useToggle2$ = _useToggle2[1],
      toggle = _useToggle2$.toggle,
      toggleOn = _useToggle2$.toggleOn,
      toggleOff = _useToggle2$.toggleOff;
  ...
  }, "Toggle"), /*#__PURE__*/react_default.a.createElement("button", {
    onClick: toggleOn
  }, "Show"), /*#__PURE__*/react_default.a.createElement("button", {
    onClick: toggleOff
  }, "Hide"), /*#__PURE__*/react_default.a.createElement("div", {
    style: {
...
/* harmony default export */ var UseToggleExample = (Example);
// CONCATENATED MODULE: ./docs/useToggle.mdx
const frontMatter={};const metadata={"unversionedId":"useToggle","id":"useToggle","isDocsHomePage":false,"title":"useToggle","description":"Use boolean value.","source":"@site/docs/useToggle.mdx","slug":"/useToggle","permalink":"/hooks/useToggle","version":"current","sidebar":"docs","previous":{"title":"useIsomorphicLayoutEffect","permalink":"/hooks/useIsomorphicLayoutEffect"},"next":{"title":"useDebounced","permalink":"/hooks/useDebounced"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Use boolean value.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useToggle(
...
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`initialValue`),`:`),` optional initial value, default is false.`)),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`value`),`:`),` a boolean value, can be changed by the following functions.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`toggle`),`:`),` toggle the value. If the newValue param is specified, the value will be set to the newValue.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`toggleOn`),`:`),` set the value to true.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`toggleOff`),`:`),` set the value to false.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseToggleExample,{mdxType:"UseToggleExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React from "react";
