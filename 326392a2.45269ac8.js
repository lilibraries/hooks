...
// CONCATENATED MODULE: ./examples/UseTimeoutExample.tsx
...
function Example() {
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("button", {
    onClick: increase
  }, "+1 after one second"), /*#__PURE__*/react_default.a.createElement("button", {
    onClick: cancel
  }, "Cancel"), " Count: ", count);
}

/* harmony default export */ var UseTimeoutExample = (Example);
// CONCATENATED MODULE: ./docs/useTimeout.mdx
const frontMatter={};const metadata={"unversionedId":"useTimeout","id":"useTimeout","isDocsHomePage":false,"title":"useTimeout","description":"Delay running callback.","source":"@site/docs/useTimeout.mdx","slug":"/useTimeout","permalink":"/hooks/useTimeout","version":"current","sidebar":"docs","previous":{"title":"useThrottle","permalink":"/hooks/useThrottle"},"next":{"title":"useInterval","permalink":"/hooks/useInterval"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Delay running callback.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useTimeout(
  callback: () => void,
  ms: number
): [start: () => void, cancel: () => void];
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`callback`),`:`),` the function that be delayed calling.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`ms`),`:`),` delay time, in milliseconds.`)),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`start`),`:`),` start function.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`cancel`),`:`),` cancel function.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseTimeoutExample,{mdxType:"UseTimeoutExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
