...
// CONCATENATED MODULE: ./examples/UseTitleExample.tsx
...
/* harmony default export */ var UseTitleExample = (Example);
// CONCATENATED MODULE: ./docs/useTitle.mdx
const frontMatter={};const metadata={"unversionedId":"useTitle","id":"useTitle","isDocsHomePage":false,"title":"useTitle","description":"Set document title.","source":"@site/docs/useTitle.mdx","slug":"/useTitle","permalink":"/hooks/useTitle","version":"current","sidebar":"docs","previous":{"title":"usePrevious","permalink":"/hooks/usePrevious"},"next":{"title":"useFavicon","permalink":"/hooks/useFavicon"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Set document title.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useTitle(title: string, options?: { restore?: boolean }): void;
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`title`),`:`),` document title.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.restore`),`:`),` restore previous title on the component unmount.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseTitleExample,{mdxType:"UseTitleExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
