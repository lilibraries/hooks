...
// CONCATENATED MODULE: ./examples/UsePageVisibleExample.tsx
...
function Example() {
  var isPageVisible = Object(src["j" /* usePageVisible */])();

  var _useState = Object(react["useState"])(["Is page visible: ".concat(isPageVisible)]),
      _useState2 = slicedToArray_default()(_useState, 2),
      logs = _useState2[0],
      setLogs = _useState2[1];

  Object(src["r" /* useUpdate */])(function () {
    setLogs(function (logs) {
      return [].concat(toConsumableArray_default()(logs), ["Is page visible: ".concat(isPageVisible)]);
    });
  }, [isPageVisible]);
  return /*#__PURE__*/react_default.a.createElement("ul", null, logs.map(function (log, index) {
...
/* harmony default export */ var UsePageVisibleExample = (Example);
// CONCATENATED MODULE: ./docs/usePageVisible.mdx
const frontMatter={};const metadata={"unversionedId":"usePageVisible","id":"usePageVisible","isDocsHomePage":false,"title":"usePageVisible","description":"Detect whether the page is visible.","source":"@site/docs/usePageVisible.mdx","slug":"/usePageVisible","permalink":"/hooks/usePageVisible","version":"current","sidebar":"docs","previous":{"title":"useDarkMode","permalink":"/hooks/useDarkMode"},"next":{"title":"useWindowSize","permalink":"/hooks/useWindowSize"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Detect whether the page is visible.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function usePageVisible(): boolean;
`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UsePageVisibleExample,{mdxType:"UsePageVisibleExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
