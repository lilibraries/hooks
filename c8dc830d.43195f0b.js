...
// CONCATENATED MODULE: ./examples/UseCookieExample.tsx




function Example() {
  var _useCookie = Object(src["b" /* useCookie */])("name", "default value"),
      _useCookie2 = slicedToArray_default()(_useCookie, 2),
      value = _useCookie2[0],
      _useCookie2$ = _useCookie2[1],
      set = _useCookie2$.set,
      remove = _useCookie2$.remove;
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("div", null, /*#__PURE__*/react_default.a.createElement("button", {
    ...
    onClick: remove
  }, "Remove")), /*#__PURE__*/react_default.a.createElement("div", null, "Cookie value: ", value));
}

/* harmony default export */ var UseCookieExample = (Example);
// CONCATENATED MODULE: ./docs/useCookie.mdx
const frontMatter={};const metadata={"unversionedId":"useCookie","id":"useCookie","isDocsHomePage":false,"title":"useCookie","description":"This hook use js-cookie as the parser. You can use this hook to get, set and/or remove cookies.","source":"@site/docs/useCookie.mdx","slug":"/useCookie","permalink":"/hooks/useCookie","version":"current","sidebar":"docs","previous":{"title":"useEventListener","permalink":"/hooks/useEventListener"},"next":{"title":"useLocalStorage","permalink":"/hooks/useLocalStorage"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`This hook use `,Object(esm["b" /* mdx */])("a",{parentName:"p","href":"https://github.com/js-cookie/js-cookie"},`js-cookie`),` as the parser. You can use this hook to get, set and/or remove cookies.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useCookie(
  name: string,
  defaultValue?: string,
...
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`name`),`:`),` cookie name.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`defaultValue`),`:`),` default value, it will be returnd when the specified cookie is non-existant.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options`),`:`),` `,Object(esm["b" /* mdx */])("a",{parentName:"li","href":"https://github.com/js-cookie/js-cookie#cookie-attributes"},`js-cookie attributes`),`.`)),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`value`),`:`),` cookie value, it may be undefined.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`set`),`:`),` a function that can set the named cookie a new value.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`remove`),`:`),` a function that can remove the named cookie, and return the defaultValue.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseCookieExample,{mdxType:"UseCookieExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React from "react";
