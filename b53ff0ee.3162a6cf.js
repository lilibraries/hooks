...
// CONCATENATED MODULE: ./examples/UseOnlineExample.tsx


function Example() {
  var online = Object(src["i" /* useOnline */])();
  return "The network is: " + (online ? "online" : "offline");
}

/* harmony default export */ var UseOnlineExample = (Example);
// CONCATENATED MODULE: ./docs/useOnline.mdx
const frontMatter={};const metadata={"unversionedId":"useOnline","id":"useOnline","isDocsHomePage":false,"title":"useOnline","description":"Detect whether the network is online.","source":"@site/docs/useOnline.mdx","slug":"/useOnline","permalink":"/hooks/useOnline","version":"current","sidebar":"docs","previous":{"title":"useFavicon","permalink":"/hooks/useFavicon"},"next":{"title":"useDarkMode","permalink":"/hooks/useDarkMode"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Detect whether the network is online.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useOnline(): boolean;
`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseOnlineExample,{mdxType:"UseOnlineExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import { useOnline } from "@lilib/hooks";
