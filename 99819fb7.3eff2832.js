...
// CONCATENATED MODULE: ./examples/UseThrottleExample.tsx
...
function Example() {
  ...
  var _useState5 = Object(react["useState"])(""),
      ...
      throttledValue = _useState6[0],
      setThrottledValue = _useState6[1];

  var _useThrottle = Object(src["m" /* useThrottle */])(function () {
    ...
    trailing: trailing
      ...
      _useThrottle2 = slicedToArray_default()(_useThrottle, 2),
      throttledCallback = _useThrottle2[0],
      _useThrottle2$ = _useThrottle2[1],
      flush = _useThrottle2$.flush,
      cancel = _useThrottle2$.cancel;

  Object(src["r" /* useUpdate */])(throttledCallback, [value]); // eslint-disable-line
...
/* harmony default export */ var UseThrottleExample = (Example);
// CONCATENATED MODULE: ./docs/useThrottle.mdx
const frontMatter={};const metadata={"unversionedId":"useThrottle","id":"useThrottle","isDocsHomePage":false,"title":"useThrottle","description":"Use throttled callback.","source":"@site/docs/useThrottle.mdx","slug":"/useThrottle","permalink":"/hooks/useThrottle","version":"current","sidebar":"docs","previous":{"title":"useDebounce","permalink":"/hooks/useDebounce"},"next":{"title":"useTimeout","permalink":"/hooks/useTimeout"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Use throttled callback.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useThrottle<T extends (...args: any[]) => any>(
  callback: T,
...
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`callback`),`:`),` original callback function.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options`),`:`),` throttle wait time or an options object.`,Object(esm["b" /* mdx */])("ul",{parentName:"li"},Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.wait`),`:`),` throttle wait time, in milliseconds.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.leading`),`:`),` run callback on the leading edge, default is false.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.trailing`),`:`),` run callback on the trailing edge, default is true.`)))),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`throttledCallback`),`:`),` throttled callback.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`flush`),`:`),` flush funciton, run callback immediately.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`cancel`),`:`),` cancel throttle timer.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseThrottleExample,{mdxType:"UseThrottleExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
