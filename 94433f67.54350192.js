...
// CONCATENATED MODULE: ./examples/UseDebounceExample.tsx
...
function Example() {
  ...
  var _useDebounce = Object(src["d" /* useDebounce */])(function () {
    ...
    trailing: trailing
      ...
      debouncedCallback = _useDebounce2[0],
      _useDebounce2$ = _useDebounce2[1],
      flush = _useDebounce2$.flush,
      cancel = _useDebounce2$.cancel;

  Object(src["r" /* useUpdate */])(debouncedCallback, [value]); // eslint-disable-line
...
/* harmony default export */ var UseDebounceExample = (Example);
// CONCATENATED MODULE: ./docs/useDebounce.mdx
const frontMatter={};const metadata={"unversionedId":"useDebounce","id":"useDebounce","isDocsHomePage":false,"title":"useDebounce","description":"Use debounced callback.","source":"@site/docs/useDebounce.mdx","slug":"/useDebounce","permalink":"/hooks/useDebounce","version":"current","sidebar":"docs","previous":{"title":"usePersist","permalink":"/hooks/usePersist"},"next":{"title":"useThrottle","permalink":"/hooks/useThrottle"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Use debounced callback.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useDebounce<T extends (...args: any[]) => any>(
  callback: T,
...
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`callback`),`:`),` original callback function.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options`),`:`),` debounce wait time or an options object.`,Object(esm["b" /* mdx */])("ul",{parentName:"li"},Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.wait`),`:`),` debounce wait time, in milliseconds.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.leading`),`:`),` run callback on the leading edge, default is false.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.trailing`),`:`),` run callback on the trailing edge, default is true.`)))),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`debouncedCallback`),`:`),` debounced callback.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`flush`),`:`),` flush funciton, run callback immediately.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`cancel`),`:`),` cancel debounce timer.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseDebounceExample,{mdxType:"UseDebounceExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
