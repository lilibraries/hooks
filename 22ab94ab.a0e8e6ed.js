...
// CONCATENATED MODULE: ./examples/UseThrottledExample.tsx
...
function Example() {
  var _useState = Object(react["useState"])(random()),
      _useState2 = slicedToArray_default()(_useState, 2),
      wait = _useState2[0],
      setWait = _useState2[1];

  var _useToggle = Object(src["q" /* useToggle */])(false),
      _useToggle2 = slicedToArray_default()(_useToggle, 2),
      leading = _useToggle2[0],
      toggleLeading = _useToggle2[1].toggle;

  var _useToggle3 = Object(src["q" /* useToggle */])(true),
      _useToggle4 = slicedToArray_default()(_useToggle3, 2),
      trailing = _useToggle4[0],
      toggleTrailing = _useToggle4[1].toggle;
  ...
  var _useThrottled = Object(src["n" /* useThrottled */])(value, options),
      _useThrottled2 = slicedToArray_default()(_useThrottled, 2),
      throttledValue = _useThrottled2[0],
      _useThrottled2$ = _useThrottled2[1],
      flush = _useThrottled2$.flush,
      cancel = _useThrottled2$.cancel;

  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("p", null, "Actions:", " ", /*#__PURE__*/react_default.a.createElement("button", {
    onClick: function onClick() {
      return setWait(random());
    }
  }, "Change wait time"), /*#__PURE__*/react_default.a.createElement("button", {
    onClick: function onClick() {
      return toggleLeading();
    }
  }, "Toggle leading"), /*#__PURE__*/react_default.a.createElement("button", {
    onClick: function onClick() {
      return toggleTrailing();
    }
  }, "Toggle trailing")), /*#__PURE__*/react_default.a.createElement("p", null, "Options:", " ", "{ wait: ".concat(wait, ", leading: ").concat(leading, ", trailing: ").concat(trailing, " }")), /*#__PURE__*/react_default.a.createElement("p", null, "Enter value:", " ", /*#__PURE__*/react_default.a.createElement("input", {
    value: value,
  ...
  }, "Flush"), /*#__PURE__*/react_default.a.createElement("button", {
    onClick: function onClick() {
      return flush("final value");
    }
  }, "Flush with \"final value\""), /*#__PURE__*/react_default.a.createElement("button", {
    onClick: cancel
  }, "Cancel")), /*#__PURE__*/react_default.a.createElement("div", null, "Throttled value: ", throttledValue));
}

/* harmony default export */ var UseThrottledExample = (Example);
// CONCATENATED MODULE: ./docs/useThrottled.mdx
const frontMatter={};const metadata={"unversionedId":"useThrottled","id":"useThrottled","isDocsHomePage":false,"title":"useThrottled","description":"Throttle a value.","source":"@site/docs/useThrottled.mdx","slug":"/useThrottled","permalink":"/hooks/useThrottled","version":"current","sidebar":"docs","previous":{"title":"useDebounced","permalink":"/hooks/useDebounced"},"next":{"title":"usePersist","permalink":"/hooks/usePersist"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Throttle a value.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useThrottled<T = any>(
  value: T,
...
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`value`),`:`),` the value that will be changed.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options`),`:`),` throttle wait time or an options object.`,Object(esm["b" /* mdx */])("ul",{parentName:"li"},Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.wait`),`:`),` throttle wait time, in milliseconds.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.leading`),`:`),` change throttledValue on the leading edge, default is false.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.trailing`),`:`),` change throttledValue on the trailing edge, default is true.`)))),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`throttledValue`),`:`),` throttled value.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`flush`),`:`),` flush funciton. The finalValue will be returned as throttledValue if it is specified.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`cancel`),`:`),` cancel throttle timer.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseThrottledExample,{mdxType:"UseThrottledExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
