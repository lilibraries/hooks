...
// CONCATENATED MODULE: ./examples/UseSessionStorageExample.tsx




function Example() {
  var _useSessionStorage = Object(src["l" /* useSessionStorage */])("key", "default value"),
      _useSessionStorage2 = slicedToArray_default()(_useSessionStorage, 2),
      value = _useSessionStorage2[0],
      _useSessionStorage2$ = _useSessionStorage2[1],
      set = _useSessionStorage2$.set,
      remove = _useSessionStorage2$.remove;
  ...
  }, "Set"), /*#__PURE__*/react_default.a.createElement("button", {
    onClick: remove
  }, "Remove")), /*#__PURE__*/react_default.a.createElement("div", null, "The value is: ", value));
}

/* harmony default export */ var UseSessionStorageExample = (Example);
// CONCATENATED MODULE: ./docs/useSessionStorage.mdx
const frontMatter={};const metadata={"unversionedId":"useSessionStorage","id":"useSessionStorage","isDocsHomePage":false,"title":"useSessionStorage","description":"Get or set sessionStorage.","source":"@site/docs/useSessionStorage.mdx","slug":"/useSessionStorage","permalink":"/hooks/useSessionStorage","version":"current","sidebar":"docs","previous":{"title":"useLocalStorage","permalink":"/hooks/useLocalStorage"},"next":{"title":"useCreate","permalink":"/hooks/useCreate"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Get or set sessionStorage.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useSessionStorage<T = any>(
  key: string,
  defaultValue?: T,
  options?: {
...
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`key`),`:`),` sessionStorage key.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`defaultValue`),`:`),` default value.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.serialize`),`:`),` options object.`,Object(esm["b" /* mdx */])("ul",{parentName:"li"},Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.serialize`),`:`),` serialization function, default is `,Object(esm["b" /* mdx */])("inlineCode",{parentName:"li"},`JSON.stringify`),`.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.deserialize`),`:`),` deserialization function, default is `,Object(esm["b" /* mdx */])("inlineCode",{parentName:"li"},`JSON.parse`),`.`)))),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`value`),`:`),` parsed by the deserialization function.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`set`),`:`),` the function that used to set sessionStorage.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`remove`),`:`),` the function that used to remove sessionStorage.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseSessionStorageExample,{mdxType:"UseSessionStorageExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React from "react";
