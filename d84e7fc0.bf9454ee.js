...
// CONCATENATED MODULE: ./examples/UseIntervalExample.tsx
...
function Example() {
  ...
  var _useInterval = Object(src["f" /* useInterval */])(function () {
    setCount(function (count) {
      return ++count;
    });
  }, 1000),
      _useInterval2 = slicedToArray_default()(_useInterval, 2),
      start = _useInterval2[0],
      cancel = _useInterval2[1];
...
/* harmony default export */ var UseIntervalExample = (Example);
// CONCATENATED MODULE: ./docs/useInterval.mdx
const frontMatter={};const metadata={"unversionedId":"useInterval","id":"useInterval","isDocsHomePage":false,"title":"useInterval","description":"Loop run callback.","source":"@site/docs/useInterval.mdx","slug":"/useInterval","permalink":"/hooks/useInterval","version":"current","sidebar":"docs","previous":{"title":"useTimeout","permalink":"/hooks/useTimeout"},"next":{"title":"useRaf","permalink":"/hooks/useRaf"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Loop run callback.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useInterval(
  callback: () => void,
  ms: number
): [start: () => void, cancel: () => void];
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`callback`),`:`),` the function that called at intervals.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`ms`),`:`),` interval time, in milliseconds.`)),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`start`),`:`),` start function.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`cancel`),`:`),` cancel function.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseIntervalExample,{mdxType:"UseIntervalExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
