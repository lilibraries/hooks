...
// CONCATENATED MODULE: ./examples/UseWindowSizeExample.tsx


function Example() {
  var _useWindowSize = Object(src["s" /* useWindowSize */])(),
...
/* harmony default export */ var UseWindowSizeExample = (Example);
// CONCATENATED MODULE: ./docs/useWindowSize.mdx
const frontMatter={};const metadata={"unversionedId":"useWindowSize","id":"useWindowSize","isDocsHomePage":false,"title":"useWindowSize","description":"Returns window width and height.","source":"@site/docs/useWindowSize.mdx","slug":"/useWindowSize","permalink":"/hooks/useWindowSize","version":"current","sidebar":"docs","previous":{"title":"usePageVisible","permalink":"/hooks/usePageVisible"},"next":{"title":"useEventListener","permalink":"/hooks/useEventListener"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Returns window width and height.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useWindowSize(): { width: number; height: number };
`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseWindowSizeExample,{mdxType:"UseWindowSizeExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import { useWindowSize } from "@lilib/hooks";
