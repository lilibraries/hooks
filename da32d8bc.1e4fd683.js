...
// CONCATENATED MODULE: ./examples/UseNextFrameExample.tsx
...
function Example() {
  ...
  var _useNextFrame = Object(src["h" /* useNextFrame */])(function () {
    return setVisible(true);
  }),
      _useNextFrame2 = slicedToArray_default()(_useNextFrame, 1),
      startShow = _useNextFrame2[0];

  var _useTimeout = Object(src["o" /* useTimeout */])(function () {
    return setDisplay(false);
  }, 1000),
      _useTimeout2 = slicedToArray_default()(_useTimeout, 1),
      startHide = _useTimeout2[0];
...
/* harmony default export */ var UseNextFrameExample = (Example);
// CONCATENATED MODULE: ./docs/useNextFrame.mdx
const frontMatter={};const metadata={"unversionedId":"useNextFrame","id":"useNextFrame","isDocsHomePage":false,"title":"useNextFrame","description":"Ensure the callback is invoked after the current paiting.","source":"@site/docs/useNextFrame.mdx","slug":"/useNextFrame","permalink":"/hooks/useNextFrame","version":"current","sidebar":"docs","previous":{"title":"useIdle","permalink":"/hooks/useIdle"},"next":{"title":"useAnimation","permalink":"/hooks/useAnimation"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Ensure the callback is invoked after the current paiting.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useNextFrame(
  callback: () => void
): [start: () => void, cancel: () => void];
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`callback`),`:`),` the function that will be invoked.`)),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`start`),`:`),` schedule function.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`cancel`),`:`),` cancel function.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseNextFrameExample,{mdxType:"UseNextFrameExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
