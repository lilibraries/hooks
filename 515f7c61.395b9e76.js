...
// CONCATENATED MODULE: ./examples/UseDarkModeExample.tsx


function Example() {
  var isDarkMode = Object(src["c" /* useDarkMode */])();
  return "Is dark mode: ".concat(isDarkMode);
}

/* harmony default export */ var UseDarkModeExample = (Example);
// CONCATENATED MODULE: ./docs/useDarkMode.mdx
const frontMatter={};const metadata={"unversionedId":"useDarkMode","id":"useDarkMode","isDocsHomePage":false,"title":"useDarkMode","description":"Detect whether the system prefers color schema is dark.","source":"@site/docs/useDarkMode.mdx","slug":"/useDarkMode","permalink":"/hooks/useDarkMode","version":"current","sidebar":"docs","previous":{"title":"useOnline","permalink":"/hooks/useOnline"},"next":{"title":"usePageVisible","permalink":"/hooks/usePageVisible"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Detect whether the system prefers color schema is dark.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useDarkMode(): boolean;
`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseDarkModeExample,{mdxType:"UseDarkModeExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import { useDarkMode } from "@lilib/hooks";
