...
// CONCATENATED MODULE: ./examples/UseLocalStorageExample.tsx




function Example() {
  var _useLocalStorage = Object(src["g" /* useLocalStorage */])("key", "default value"),
      _useLocalStorage2 = slicedToArray_default()(_useLocalStorage, 2),
      value = _useLocalStorage2[0],
      _useLocalStorage2$ = _useLocalStorage2[1],
      set = _useLocalStorage2$.set,
      remove = _useLocalStorage2$.remove;
...
/* harmony default export */ var UseLocalStorageExample = (Example);
// CONCATENATED MODULE: ./docs/useLocalStorage.mdx
const frontMatter={};const metadata={"unversionedId":"useLocalStorage","id":"useLocalStorage","isDocsHomePage":false,"title":"useLocalStorage","description":"Get or set localStorage.","source":"@site/docs/useLocalStorage.mdx","slug":"/useLocalStorage","permalink":"/hooks/useLocalStorage","version":"current","sidebar":"docs","previous":{"title":"useCookie","permalink":"/hooks/useCookie"},"next":{"title":"useSessionStorage","permalink":"/hooks/useSessionStorage"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Get or set localStorage.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useLocalStorage<T = any>(
  key: string,
  defaultValue?: T,
  options?: {
...
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`key`),`:`),` localStorage key.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`defaultValue`),`:`),` default value.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.serialize`),`:`),` options object.`,Object(esm["b" /* mdx */])("ul",{parentName:"li"},Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.serialize`),`:`),` serialization function, default is `,Object(esm["b" /* mdx */])("inlineCode",{parentName:"li"},`JSON.stringify`),`.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.deserialize`),`:`),` deserialization function, default is `,Object(esm["b" /* mdx */])("inlineCode",{parentName:"li"},`JSON.parse`),`.`)))),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`value`),`:`),` parsed by the deserialization function.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`set`),`:`),` the function that used to set localStorage.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`remove`),`:`),` the function that used to remove localStorage.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseLocalStorageExample,{mdxType:"UseLocalStorageExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React from "react";
