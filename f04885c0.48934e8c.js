...
// CONCATENATED MODULE: ./examples/UseDebouncedExample.tsx
...
function Example() {
  ...
  var _useDebounced = Object(src["e" /* useDebounced */])(value, options),
      _useDebounced2 = slicedToArray_default()(_useDebounced, 2),
      debouncedValue = _useDebounced2[0],
      _useDebounced2$ = _useDebounced2[1],
      flush = _useDebounced2$.flush,
      cancel = _useDebounced2$.cancel;
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("p", null, "Actions:", " ", /*#__PURE__*/react_default.a.createElement("button", {
    ...
    onClick: cancel
  }, "Cancel")), /*#__PURE__*/react_default.a.createElement("div", null, "Debounced value: ", debouncedValue));
}

/* harmony default export */ var UseDebouncedExample = (Example);
// CONCATENATED MODULE: ./docs/useDebounced.mdx
const frontMatter={};const metadata={"unversionedId":"useDebounced","id":"useDebounced","isDocsHomePage":false,"title":"useDebounced","description":"Debounce a value.","source":"@site/docs/useDebounced.mdx","slug":"/useDebounced","permalink":"/hooks/useDebounced","version":"current","sidebar":"docs","previous":{"title":"useToggle","permalink":"/hooks/useToggle"},"next":{"title":"useThrottled","permalink":"/hooks/useThrottled"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Usage',id:'usage',children:[{value:'Params',id:'params',children:[]},{value:'Results',id:'results',children:[]}]},{value:'Example',id:'example',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])("p",null,`Debounce a value.`),Object(esm["b" /* mdx */])("h2",{"id":"usage"},`Usage`),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-ts"},`function useDebounced<T = any>(
  value: T,
...
`)),Object(esm["b" /* mdx */])("h3",{"id":"params"},`Params`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`value`),`:`),` the value that will be changed.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options`),`:`),` debounce wait time or an options object.`,Object(esm["b" /* mdx */])("ul",{parentName:"li"},Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.wait`),`:`),` debounce wait time, in milliseconds.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.leading`),`:`),` change debouncedValue on the leading edge, default is false.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`options.trailing`),`:`),` change debouncedValue on the trailing edge, default is true.`)))),Object(esm["b" /* mdx */])("h3",{"id":"results"},`Results`),Object(esm["b" /* mdx */])("ul",null,Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`debouncedValue`),`:`),` debounced value.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`flush`),`:`),` flush funciton. The finalValue will be returned as debouncedValue if it is specified.`),Object(esm["b" /* mdx */])("li",{parentName:"ul"},Object(esm["b" /* mdx */])("strong",{parentName:"li"},Object(esm["b" /* mdx */])("inlineCode",{parentName:"strong"},`cancel`),`:`),` cancel debounce timer.`)),Object(esm["b" /* mdx */])("h2",{"id":"example"},`Example`),Object(esm["b" /* mdx */])(ExampleBox["a" /* default */],{mdxType:"ExampleBox"},Object(esm["b" /* mdx */])(UseDebouncedExample,{mdxType:"UseDebouncedExample"})),Object(esm["b" /* mdx */])("pre",null,Object(esm["b" /* mdx */])("code",{parentName:"pre","className":"language-tsx"},`import React, { useState } from "react";
